  ...
  return <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={createNewProject} className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {projects.length === 0 ? <div className="text-center py-16">
            ...
            {projects.map(project => <Card key={project.id} className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate(`/project/${project.id}`)}>
                <CardHeader>
